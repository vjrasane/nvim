...
require("lazyvim.util").on_load("telescope.nvim", function()
  ...
  keys = {
    ...
    { "<leader>sW", require("lazyvim.util").telescope("grep_string", { cwd = false, word_match = "-w" }), desc = "Word (cwd)" },
    { "<leader>sw", require("lazyvim.util").telescope("grep_string"), mode = "v", desc = "Selection (root dir)" },
    { "<leader>sW", require("lazyvim.util").telescope("grep_string", { cwd = false }), mode = "v", desc = "Selection (cwd)" },
    { "<leader>uC", require("lazyvim.util").telescope("colorscheme", { enable_preview = true }), desc = "Colorscheme with preview" },
    {
      "<leader>ss",
      function()
